...
export const SelectCustomize = () => {
  ...
  <div className="flex items-center justify-center gap-10 z-10">
            <NavLink to="/customize1">
                <div className="border-4 rounded-md hover:border-orange-500 border-gray-500">
                <img src={specialized} alt="" className="h-48 w-48 object-contain" />
                </div>
            </NavLink>
            <NavLink to="/customize2">
                <div className="border-4 rounded-md hover:border-orange-500 border-gray-500">
                <img src={exploro} alt="" className="h-[12rem] w-48" />
                </div>
            </NavLink>
            <NavLink to="/customize3">
                <div className="border-4 rounded-md hover:border-orange-500 border-gray-500">
                <img src={wilier} alt="" className="h-48 w-48 object-contain" />
                </div>
            </NavLink>
            </div> 
  </div>
